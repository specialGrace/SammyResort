...
const navigation = [
  ...
  { name: 'Cards', href: '/card', icon: CreditCardIcon, current: false },
  { name: 'Recipients', href: '/recipient', icon: UserGroupIcon, current: false },
...
const cards = [
  { name: 'Account balance', href: '/balance', icon: ScaleIcon, amount: '$30,659.45' },
  // More items...
]
const transactions = [
  {
